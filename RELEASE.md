...
- `D:\claude\XiaoBaiLong\dist\小白龙 Setup 0.1.1.exe`
- `D:\claude\XiaoBaiLong\dist\latest.yml`

## Local Verification Checklist

1. Install `小白龙 Setup 0.1.1.exe`.
...
- GitHub Release asset: `小白龙 Setup 0.1.1.exe`
- GitHub Release asset: `latest.yml`
- GitHub Release asset: `小白龙 Setup 0.1.1.exe.blockmap`
