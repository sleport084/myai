...
<section class="console" id="chat-area">
  ...
  <div id="input-row">
    ...
    <textarea id="msg-input" rows="1" placeholder="发送消息… 按住空格键说话（输入 / 调命令，Shift+Enter 换行）" autocomplete="off"></textarea>
      ...
      <div class="settings-content">
        ...
        <div class="settings-tab active" data-tab="appearance">
          ...
          <div class="settings-section">
            ...
            <div class="settings-row">
              ...
              <input class="settings-input" id="settings-agent-name" type="text" maxlength="32" autocomplete="off" spellcheck="false" placeholder="MyAI">
            </div>
        ...
        <div class="settings-tab" data-tab="mcp">
          <div class="settings-section">
            ...
            <p class="settings-hint">保存后MyAI会启动已启用的 MCP Server、读取工具目录，并通过 find_tool 按需加载工具。command 会直接启动本地程序，请只配置你信任的 Server。环境变量会加密保存在本机；已保存的值显示为 [configured]。</p>
            <textarea
    ...
    "timeoutMs": 60000
        ...
        <div class="settings-tab" data-tab="security">
          ...
          <div class="settings-section">
            ...
            <p class="settings-hint">允许同一局域网内的设备访问本机MyAI。语音输入需要 HTTPS；远程设置和 WebSocket 使用下方口令配对。开启或关闭后需要重启应用生效。</p>
            <div class="settings-row">
            ...
            <div id="security-lan-share" style="display:none;margin-top:12px;">
              <div style="display:flex;gap:16px;flex-wrap:wrap;align-items:flex-start;">
                ...
                <div style="text-align:center;">
                  <div class="settings-hint" style="margin-bottom:6px;">② 扫码访问MyAI</div>
                  <img id="security-lan-access-qr" alt="MyAI局域网访问二维码" style="width:200px;height:200px;background:#fff;padding:6px;border-radius:8px;">
                </div>
              </div>
            </div>
          ...
          <div class="settings-section">
            ...
            <div class="settings-row"><label class="settings-label"><input type="checkbox" class="security-blocked-tool" value="chrome_devtools_browser"> MyAI内置浏览器 &nbsp;<span style="color:var(--ink2);font-size:12px;">（Chrome DevTools MCP 的全部网页搜索、读取与浏览器操作）</span></label></div>
        ...
        <div class="settings-tab" data-tab="advanced">
          <div class="settings-section">
            ...
            <p class="settings-hint">控制MyAI是否按固定节奏自主思考。关闭后不会再自动触发 L2 心跳，但用户消息和定时提醒仍会正常处理。</p>
            <div class="settings-row">
