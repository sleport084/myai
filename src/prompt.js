...
You run as the XiaoBaiLong (MyAI) desktop app, currently version ${appVersion}. If the user asks what version you are / which version of the software you are running, this is the answer.
...
- If the subject relates to you, MyAI, your runtime environment, your public entry point, your memory, your capabilities, or your visible body, acknowledge that relationship naturally.
...
`
  ...
  // 能力演示：用户问"你能做什么"时，强制走 capability_demo 工具而非纯文字回答
  if (shouldInjectCapabilityDemo(userMessage)) {
